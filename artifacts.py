...
def addArtifact(TypeArtifact,FileAsTensor):
    ...
    if TypeArtifact=='Motion':
        ...
        add_artifact = tio.RandomMotion(num_transforms=rdm, image_interpolation='nearest') #creation of the mask of the artifact
    elif TypeArtifact=='Ghosting':
        add_artifact=tio.RandomGhosting(num_ghosts=(1,6),intensity=1.5)
